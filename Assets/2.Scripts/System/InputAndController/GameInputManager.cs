...
public static class GameInputManager
{
    ...
    static void InitializeActionsDictionary()
    {
        ...
        if (OptionsData.optionsSaveData != null && OptionsData.optionsSaveData.keyMapping != null && OptionsData.optionsSaveData.keyMapping.Count > 0)
        {
            LoadCustomMappings();
        }
        else
    ...
    private static void LoadCustomMappings()
    {
        ...
        if (keyMapping.Count >= (int)PlayerActions.Count)
        {
            keyMapping[7] = (int)Key.Escape;
            keyMapping[8] = (int)Key.Tab;
        }
    ...
    private static void LoadDefaultMappings()
    {
        for (int i = 0; i < (int)PlayerActions.Count; i++)
        {
            ...
            if (OptionsData.optionsSaveData != null)
            {
